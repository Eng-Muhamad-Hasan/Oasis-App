...
export function AppText({ variant = 'body', tone = 'default', style, selectable = true, ...props }: AppTextProps) {
  ...
  const variantStyles = {
    ...
    subtitle: { fontSize: typography.subtitle, lineHeight: 24, fontWeight: '800' },
    body: { fontSize: typography.body, lineHeight: 22, fontWeight: '400' },
    caption: { fontSize: typography.caption, lineHeight: 18, fontWeight: '600' },
    eyebrow: { fontSize: 12, lineHeight: 16, fontWeight: '900', textTransform: 'uppercase' },
  } as const;
  const toneColors = {
    default: colors.text,
