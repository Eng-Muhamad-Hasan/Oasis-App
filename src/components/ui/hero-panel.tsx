...
export function HeroPanel({ eyebrow, title, body, meta }: HeroPanelProps) {
  ...
  return (
    <Card style={{ gap: spacing.lg, padding: spacing.xl, backgroundColor: colors.surfaceStrong, borderColor: colors.border }}>
      ...
      {meta ? (
        <View style={{ alignSelf: 'flex-start', borderRadius: radius.pill, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, backgroundColor: colors.primarySoft }}>
